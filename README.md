...
**Combine results from multiple sub processings** This kind of processing might be considered similar to map-reduce type of algorithms. We process small chunks of data and later we will combine results.
